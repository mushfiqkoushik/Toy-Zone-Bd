	...
	<form novalidate="" action="" className="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-gray-900">
			<div className="space-y-2 col-span-full lg:col-span-1">
				<p className="font-medium text-3xl">Personal Inormation</p>
				<p className="text-xl"> please write about Toy Cars Zone </p>
			</div>
		...
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div className="col-span-full">
					<label for="bio" className="text-sm">ABOUT TOY CARS ZONE</label>
				...
				<div className="col-span-full">
					...
					<div className="flex items-center space-x-2">
						<img src="https://source.unsplash.com/30x30/?random" alt="" className="w-10 h-10 rounded-full dark:bg-gray-500 bg-gray-700" />
						<button type="button" className="px-4 py-2 border rounded-md border-gray-100">SUBMIT</button>
					</div>
				</div>
			</div>
		</fieldset>
